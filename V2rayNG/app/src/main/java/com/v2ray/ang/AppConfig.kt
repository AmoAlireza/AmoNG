...
object AppConfig {
    ...
    const val APP_URL = "$GITHUB_URL/AmoAlireza/AmoNG"
    const val APP_API_URL = "https://api.github.com/repos/AmoAlireza/AmoNG/releases"
    const val APP_ISSUES_URL = "$APP_URL/issues"
    const val APP_WIKI_MODE = "$APP_URL/wiki/Mode"
    const val APP_PRIVACY_POLICY = "$GITHUB_RAW_URL/AmoAlireza/AmoNG/master/CR.md"
